...
struct  ClientSessionInfo_t695  : public Object_t
{
	...
	ByteU5BU5D_t601* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t601* ___masterSecret_5;
};
struct ClientSessionInfo_t695_StaticFields{
