...
struct  SimpleCollator_t1036  : public Object_t
{
	...
	CodePointIndexer_t1022 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1022 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1036_StaticFields{
	...
	SimpleCollator_t1036 * ___invariant_1;
};
